...
<body>
	...
	<h2>以收到您的訂位</h2>
	<table>
<tr><td>訂位編號  :</td><td>${BookingData.bookingid}</td></tr>
<tr><td>姓名  :</td><td>${BookingData.name}</td></tr>
<tr><td>手機  :</td><td>${BookingData.phone}</td></tr>
<tr><td>訂位日期  :</td><td style="color:red">${BookingData.date}</td></tr>
<tr><td>訂位時間  :</td><td style="color:red">${BookingData.time}</td></tr>
<tr><td>訂位人數  :</td><td>${BookingData.people}</td></tr>
